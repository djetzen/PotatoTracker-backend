...
class RepositoryTest(unittest.TestCase):
    ...
    def test_element_is_saved(self):
        ...
        first_saved_element = self.repository.create_new_element(
        ...
        all_saved_elements = self.repository.find_all_elements()
        self.assertEqual(0, len(empty_elements))
        self.assertEqual(2, len(all_saved_elements))
        self.assertEqual("Lemons", first_saved_element.name)
        self.assertEqual(5, first_saved_element.amount)
        self.assertEqual(3.50, first_saved_element.price)
    ...
    def test_purchase_is_created(self):
        ...
        bought_elements = self.repository.buy_elements([element1, element2])
    ...
    def create_element(
        self, name="", amount=0, price=0.0, bought=False, user_name="", purchase_id=None
    ):
        return Element(
            name=name,
            amount=amount,
